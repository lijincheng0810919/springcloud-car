...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAI4FnUxa9yYhCSZQ66dM7V";
    private String accessKeySecret = "uO3ggYW3qipZd1BxSXVqltAYnfAa8f";
    // 空间
    private String bucketName = "1904";
    // 文件存储目录
    private String filedir = "carimg/";
